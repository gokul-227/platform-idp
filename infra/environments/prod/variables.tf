...
variable "platform_api_url" {
  ...
  default     = "https://api.platform.os.build"
}
...
variable "mail_from_address" {
  ...
  default     = "no-reply@mail.id.os.build"
}
...
variable "platform_api_service_account" {
  ...
  default     = "cloud-run-platform-api@platform-prod-495017.iam.gserviceaccount.com"
}
